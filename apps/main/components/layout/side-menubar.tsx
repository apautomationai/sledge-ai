  ...
  return (
    ...
    >
      <div className="flex h-full max-h-screen flex-col">
        ...
        <div
          className={cn(
            "flex h-14 shrink-0 items-center border-b border-border/40 px-4 lg:h-[60px]",
        ...
        <div className="flex flex-col border-t border-border/40 p-3">
          ...
          <div className="mt-4 flex flex-col gap-2">
            ...
            >
              ...
              {!isCol && (
                <span className="truncate text-sm">Report a Bug</span>
              )}{" "}
              {/* same size as support text */}
            </Link>
            ...
            >
              ...
              {!isCol && (
                <span className="truncate text-sm">support@getsledge.com</span>
              )}{" "}
              {/* same size as report text */}
            </Link>
          </div>
