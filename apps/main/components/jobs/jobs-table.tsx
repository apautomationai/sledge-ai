...
export function JobsTable({
  ...
  const handleRegenerate = async (e: React.MouseEvent, jobId: string) => {
    ...
    try {
      ...
      const errorMessage =
        error?.response?.data?.message || "Failed to regenerate attachment";
                        ...
                        {job.invoiceStatusCounts ? (
                          <div className="flex items-center gap-2 text-sm">
                            <span className="text-green-600">
                              ✓ {job.invoiceStatusCounts.approved}
                            </span>
                            <span className="text-red-600">
                              ✗ {job.invoiceStatusCounts.rejected}
                            </span>
                            <span className="text-yellow-600">
                              ⏳ {job.invoiceStatusCounts.pending}
                            </span>
                          </div>
                        ) : (
                        ...
                        <div className="flex items-center justify-end gap-2">
                          ...
                          <DropdownMenu>
                            ...
                            >
                              ...
                              <DropdownMenuItem
                                onClick={(e) =>
                                  handleDeleteClick(e, job.id, job.filename)
                                }
                                disabled={isDeleting}
