export default function WhatIsIt() {
  return (
    <div className="w-full bg-neutral-900 flex flex-col justify-start items-center">
      <div className="w-full py-8 sm:py-12 md:py-16 flex flex-col justify-start items-center gap-2 sm:gap-4">
        <div className="w-full max-w-7xl px-4 sm:px-6 lg:px-8 flex flex-col justify-start items-center gap-3 sm:gap-4 md:gap-6">
