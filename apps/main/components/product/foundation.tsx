        ...
        <div className="w-full flex flex-col lg:flex-row items-center gap-12">
          ...
          <div className="flex-1 text-white">
            ...
            <p className="text-base md:text-xl text-white mb-6">
              ...
              operates behind the scenes. AI continuously monitors incoming
              work, interprets unstructured data, executes workflows
              automatically, and pauses only when human approval is required.
              <br></br>This AI foundation powers everything in the platform —
