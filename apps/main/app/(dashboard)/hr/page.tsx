...
export default function HRPage() {
  return (
    <div className="flex flex-col gap-3 sm:gap-4 w-full">
      <div className="mb-2">
        <h1 className="text-2xl sm:text-3xl font-bold tracking-tight">HR</h1>
        <p className="text-sm sm:text-base text-muted-foreground mt-1">
          Manage your team and human resources.
        </p>
      </div>
      ...
      <div className="flex flex-col items-center justify-center min-h-[60vh]">
        <div className="relative">
          ...
          <div className="relative flex items-center justify-center w-24 h-24 rounded-full bg-gradient-to-br from-[#D4AF37]/20 to-[#D4AF37]/5 border border-[#D4AF37]/20">
            <UserCog className="h-10 w-10 text-[#D4AF37]" />
          </div>
        </div>
        ...
        <p className="text-muted-foreground text-center max-w-sm">
          Comprehensive HR management tools are on the way. We'll notify you when it's ready.
        </p>
      </div>
    </div>
  );
