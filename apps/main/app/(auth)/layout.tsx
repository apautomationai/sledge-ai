      ...
      <div className="flex min-h-screen md:h-screen md:max-h-[1080px] relative overflow-hidden">
        ...
        >
          <div className="flex flex-col relative z-10 w-full py-8 md:py-0">
            ...
            <div className="flex-1 flex justify-center items-center px-12 md:px-4 lg:px-10 xl:px-12 py-0 md:py-16">
              <div className="w-full max-w-md md:max-w-none">{children}</div>
            </div>
            ...
            <div className="w-full text-center py-4 md:py-6 px-6 mt-auto">
              <Link
                ...
                className="text-zinc-400 text-sm font-normal font-['Inter'] underline leading-5 hover:text-zinc-400 active:text-zinc-400 focus:text-zinc-400 focus:outline-none"
              >
                Terms of Service
              </Link>
              <span className="text-zinc-400 text-sm font-normal font-['Inter'] leading-5">
                {" "}
                |{" "}
              </span>
              <Link
