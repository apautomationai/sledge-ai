...
export const metadata: Metadata = {
  title: "AI Construction Management Software | Sledge",
  description:
    "Sledge is an AI-powered construction management software built to automate invoice processing and back-office workflows.",
  openGraph: {
    title: "AI Construction Management Software | Sledge",
    description:
      "Sledge is an AI-powered construction management software built to automate invoice processing and back-office workflows.",
