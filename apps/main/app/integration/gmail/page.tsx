...
export const metadata: Metadata = {
  title: "Gmail Integration for Construction Accounts Payable | Sledge",
  description:
    "Automatically capture and prepare construction invoices from Gmail using AI. No forwarding rules, no manual downloads.",
  openGraph: {
    title: "Gmail Integration for Construction Accounts Payable | Sledge",
    description:
      "Automatically capture and prepare construction invoices from Gmail using AI. No forwarding rules, no manual downloads.",
